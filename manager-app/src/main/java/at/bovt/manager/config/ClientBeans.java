...
public class ClientBeans {
    ...
    public static class StandaloneClientConfig {
        ...
        public RestClientProductsRestClient productsRestClient(
                @Value("${shopping4you.services.catalogue.uri:http://localhost:8081}") String catalogueBaseUri,
                ClientRegistrationRepository clientRegistrationRepository,
                OAuth2AuthorizedClientRepository authorizedClientRepository,
                @Value("${shopping4you.services.catalogue.registration-id:keycloak}") String registrationId) {
