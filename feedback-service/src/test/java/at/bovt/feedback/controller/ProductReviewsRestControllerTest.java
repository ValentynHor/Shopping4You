...
import at.bovt.feedback.controller.payload.NewProductReviewPayload;
import at.bovt.feedback.entity.ProductReview;
import at.bovt.feedback.service.ProductReviewsService;
...
class ProductReviewsRestControllerTest {
    ...
    void createProductReview_ReturnsCreatedProductReview() {
        ...
        doReturn(Mono.just(new ProductReview(UUID.fromString("5a9ba234-cbd6-11ee-acab-5748ca6678b9"), 1, 4,
                ...
                .createProductReview(1, 4, "...", "5f1d5cf8-cbd6-11ee-9579-cf24d050b47c");
        ...
        StepVerifier.create(this.controller.createProductReview(
                        ...
                        Mono.just(new NewProductReviewPayload(1, 4, "...")),
