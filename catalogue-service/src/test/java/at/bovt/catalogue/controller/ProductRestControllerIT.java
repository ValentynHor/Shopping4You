        ...
        this.mockMvc.perform(requestBuilder)
                ...
                .andDo(document("catalogue/products/find_all",
                        preprocessResponse(prettyPrint(), new HeadersModifyingOperationPreprocessor()
                                .remove("Vary")),
                        responseFields(
                                fieldWithPath("id").description("ID").type("int"),
                                fieldWithPath("title").description("Ware").type("string"),
                                fieldWithPath("details").description("Beschreibung").type("string")
                        )
                        ));
    }
